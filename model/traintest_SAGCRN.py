...
parser.add_argument('--dataset', type=str, choices=['METRLA', 'PEMSBAY', 'PEMSD8'], default='METRLA', help='which dataset to run')
...
parser.add_argument('--mem_num', type=int, default=30, help='number of meta-nodes/prototypes')
...
if args.dataset == 'METRLA':
    data_path = f'../{args.dataset}/metr-la-restored.h5'
    args.num_nodes = 207
    args.lr = 0.001
elif args.dataset == 'PEMSBAY':
    data_path = f'../{args.dataset}/pems-bay-restored.h5'
    args.num_nodes = 325
elif args.dataset == 'PEMSD8':
    data_path = f'../{args.dataset}/pemsd8-restored.h5'
    args.num_nodes = 170
    args.lr = 0.005
else:
